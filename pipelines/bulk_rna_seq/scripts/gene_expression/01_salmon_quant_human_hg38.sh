...
# Nacev Lab bulk RNA-seq template: human gene-level quantification with Salmon.
# Standard reference: human hg38.
#
...
OUTPUT_DIR="/path/to/output/salmon_hg38"
SALMON_INDEX="/path/to/salmon_index_hg38"
THREADS=8
LIBRARY_TYPE="A"
...
echo "Human hg38 Salmon quantification"
...
echo "All available human hg38 Salmon samples processed."
